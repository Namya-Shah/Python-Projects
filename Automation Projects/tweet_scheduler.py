...
gc = gspread.service_account(filename='gd_credentials.json')
sh = gc.open_by_key("1bfG4UV4YEJBCVvrhHktSy8KJ6Ps5YHl2DXdTYPL77cI")
worksheet = sh.sheet1
        ...
        if not done:
            ...
            if post_time < now_time:
                try:
                    ...
                    worksheet.update_cell(row_idx, 3, 1)
